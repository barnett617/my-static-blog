...
- 首页一开始没考虑屏幕分辨率和比例问题以及浏览器的兼容问题，后该用 bootstrap 简单模板，达到兼容旧版 IE 浏览器效果，并且为响应式布局，屏幕可任意缩放。
  ![首页](20161102144350917.png)

---

- 注册页面采用 angularJS 前端框架实现客户端表单验证

![这里写图片描述](20161102145206140.png)

---

- 日期使用[jedate.js](http://www.jayui.com/jedate/)控件

![这里写图片描述](20161102145310781.png)

---

- 注册成功提示（后台为新注册用户分配三个随机邀请码用于邀请其他用户注册本系统）
  ![这里写图片描述](20161102150106378.png)

---

- 个人主页使用 easyui 框架
  ![这里写图片描述](20161102150253739.png)

---

- 管理员首页（可分页显示用户）
  ![这里写图片描述](20161102154604257.png)
